...
func (z *ZabbixClient) HostgroupGet(params HostgroupGetParams) ([]HostgroupObject, error) {
...
func (z *ZabbixClient) HostgroupCreate(params []HostgroupObject) ([]int, error) {
...
func (z *ZabbixClient) HostgroupDelete(groupIDs []int) ([]int, error) {
